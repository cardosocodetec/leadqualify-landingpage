...
const Section = React.lazy(() => import("../Layout5/Section"));
  ...
  constructor(props) {
    ...
    this.state = {
      navItems: [
        ...
        { id: 2, idnm: "about", navheading: "Sobre" },
        { id: 3, idnm: "services", navheading: "serviços" },
        { id: 4, idnm: "features", navheading: "Recursos" },
        { id: 7, idnm: "contact", navheading: "Nosso Contato" },
      ],
